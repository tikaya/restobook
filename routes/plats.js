...
router.post('/', validatePlat, platController.create); // Créer un nouveau plat avec validation
router.put('/:id', validatePlatUpdate, platController.update); // Mettre à jour un plat existant avec validation
router.delete('/:id', platController.delete); // Supprimer un plat
